...
gulp.task("views", function(){
  return gulp.src("./app/*.html")
          ...
          .pipe(gulpif(build, replace("slider.js", "main.min.js")))
          .pipe(gulp.dest("./dist/"))
...
exports.default = gulp.series("clean", gulp.parallel("views", "styles", "scripts", "images", "fonts"), gulp.parallel("watches", "browserSync"))

exports.build = gulp.series(onBuild, "clean", "views", "styles", "scripts", "images", "fonts");
